...
import com.ouroverde.backend.dto.LoginRequestDTO;
...
public class AdministradorController {
    ...
    @PostMapping("/login")
    public ResponseEntity<Administrador> login(@RequestBody LoginRequestDTO dto) {
        return repository.findByEmail(dto.getEmail())
                .filter(admin -> admin.getSenha().equals(dto.getSenha()))

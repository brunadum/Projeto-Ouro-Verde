...
import com.ouroverde.backend.exception.EstoqueInsuficienteException;
        ...
        if (dto.getItens() != null && !dto.getItens().isEmpty()) {
            for (ItemReservaDTO itemDto : dto.getItens()) {
                ...
                if (material.getQuantidadeEstoque() < itemDto.getQuantidadeAlocada()) {
                    throw new EstoqueInsuficienteException("Estoque insuficiente para o material: " + material.getNome());
                }
